...
# Get the device address from the user:
print("Enter current device address (0-65535):")
device_address = int(input())

node = sx126x.sx126x(serial_num="/dev/ttyS0", freq=433, addr=device_address, power=22, rssi=False)
...
try:
    ...
    print("Invalid address. Please enter a number between 0 and 65535.")
